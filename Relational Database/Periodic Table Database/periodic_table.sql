...
--
-- Name: types types_type_id_pk; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.types
    ADD CONSTRAINT types_type_id_pk PRIMARY KEY (type_id);
...
--
-- Name: properties properties_type_id_gk; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT properties_type_id_gk FOREIGN KEY (type_id) REFERENCES public.types(type_id);
